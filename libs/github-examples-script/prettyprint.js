(function(exports, ctx) {
	...
	$().ready(function(){
		...
		$("<link href='libs/github-examples-script/prism.css' rel='stylesheet'>").appendTo('head');
		$("<script type='text/javascript' src='libs/github-examples-script/prism.js' >").appendTo('head');
		...
		if ( $("#src").length == 0 ) {
			$('body').append('<div id="src"> <p>Code: </p></div>');  
		}
